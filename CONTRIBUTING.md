...
- Run the regression testing checklist (`docs/5-testing/1-testing-checklist.md`)
...
5. Add test cases to `docs/5-testing/1-testing-checklist.md`
...
See `docs/5-testing/1-testing-checklist.md` — 70+ test cases covering all endpoints.
...
| `docs/5-testing/1-testing-checklist.md` | Full regression test suite |
...
| `ORGANIZATION.md` | Legal info, officers, accounts, dashboards, AWS resources |
...
| `docs/2-system-design/4-backend-design.md` | All 28 Lambda functions, what each does |
...
2. **`docs/5-testing/1-testing-checklist.md`** — Add new test cases if new features were added
