...
- **Backend**: 25 AWS Lambda functions (Node.js 18) via API Gateway
- **Database**: DynamoDB (5 tables: Users, Donations, Rate Limits, Blog Posts, Research Articles)
