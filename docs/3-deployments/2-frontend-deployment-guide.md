...
aws s3api create-bucket \
  --bucket fartooyoung-stg-frontend \
  --region us-east-1
```
...
```bash
aws s3 website s3://fartooyoung-stg-frontend/ \
...
aws s3api put-bucket-policy \
  ...
  --policy '{
    ...
    "Statement": [{
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::fartooyoung-stg-frontend/*"
    }]
  }'
```
...
```json
{
  ...
  "Origins": {
    "Quantity": 1,
    "Items": [{
      "Id": "S3-fartooyoung-stg-frontend",
      "DomainName": "fartooyoung-stg-frontend.s3.us-east-1.amazonaws.com",
      "S3OriginConfig": {
  ...
  "DefaultCacheBehavior": {
    "TargetOriginId": "S3-fartooyoung-stg-frontend",
...
### Staging
- **S3 Bucket:** fartooyoung-stg-frontend
