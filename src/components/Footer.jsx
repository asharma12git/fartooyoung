      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-3 gap-16">
          ...
          <div className="grid grid-cols-2 gap-8">
            {/* Left Section 1 */}
            <div>
              <h3 className="text-xl font-medium text-gray-300 mb-6">ORGANIZATION</h3>
            ...
            {/* Left Section 2 */}
            <div>
              <h3 className="text-xl font-medium text-gray-300 mb-6">HOURS</h3>
              <div className="space-y-3 text-gray-400 text-base">
          ...
          <div className="grid grid-cols-2 gap-8">
            {/* Right Section 1 */}
            <div>
              <h3 className="text-xl font-medium text-gray-300 mb-6">CONTACT</h3>
              <div className="space-y-3 text-gray-400 text-base">
            ...
            {/* Right Section 2 */}
            <div>
              <h3 className="text-xl font-medium text-gray-300 mb-6">SOCIALS</h3>
