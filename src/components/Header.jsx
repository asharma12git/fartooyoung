      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-40 py-6 pt-8">
          ...
          <div className="flex items-center justify-end space-x-4 -mr-32">
            ...
            >
              <span className="text-white/90 text-xl font-medium transition-colors duration-300 hover:text-orange-200">Login</span>
            ...
            <button
              ...
              className="flex items-center space-x-2"
            >
              <span className="text-white/90 text-xl font-medium transition-colors duration-300 hover:text-orange-200">Donate</span>
              <div className="bg-orange-500/80 backdrop-blur-sm p-2 rounded-md border border-orange-400/50 hover:bg-orange-600/90 transition-colors duration-300">
