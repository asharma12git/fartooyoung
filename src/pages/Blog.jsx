...
const CategoryPlaceholder = ({ category }) => {
  ...
  return (
    <div className={`w-full h-full bg-gradient-to-br ${gradient} flex items-center justify-center`}>
      <span className="text-white/80 text-[9px] font-bold uppercase tracking-wider">{category || 'Article'}</span>
    </div>
  )
}
      ...
      <div className="bg-gray-50 pt-12 sm:pt-16 pb-16 sm:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center border-b border-gray-200 mb-4">
            <div className="flex-1 flex items-center justify-between mr-12">
              {categories.map((cat, i) => (
                <div key={cat} className="flex items-center">
                  ...
                  {i < categories.length - 1 && <span className="h-4 w-px bg-gray-300 mb-3"></span>}
                </div>
              ))}
            </div>
            {/* Orange divider + Latest Research - aligned with right panel */}
            <div className="hidden lg:flex items-center w-80 pl-8 flex-shrink-0 border-l border-orange-500">
              <button
          ...
          <div className="flex flex-col lg:flex-row">
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 text-xs text-gray-500 mb-1">
                            {post.category && <span className="text-orange-600 font-semibold uppercase">{post.category}</span>}
                            <span>·</span>
            ...
            {/* Vertical Divider */}
            <div className="hidden lg:block w-px bg-gray-300 flex-shrink-0"></div>

            {/* Right Panel */}
            <div className="hidden lg:flex lg:flex-col w-80 pl-8 flex-shrink-0">
